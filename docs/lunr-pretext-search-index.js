...
},
{
  ...
  "number": "7.0.13",
  "title": "",
  "body": " Eighth roots of unity     alignments=['ne','ne','ne','nw','nw','sw','se','se']  labels=['1','\\omega','i','\\omega^3','-1','\\omega^5','-i','\\omega^7']  f(t)=(cos(pi*t\/4),sin(pi*t\/4))        ${labels[k]}        "
},
{
  "id": "chap-examples-16",
  "level": "2",
...
},
{
  ...
  "number": "7.9",
  "title": "",
  "body": "   <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x)=7-(x+1)^2\/2<\/definition> <definition>x0 = 1<\/definition> <coordinates bbox=\"(-8,-8,8,8)\"> <grid-axes xlabel=\"x\" ylabel=\"y\"\/> <graph function=\"f\"\/> <tangent-line function=\"f\" point=\"x0\" name=\"tan\"\/> <point p=\"(x0,f(x0))\" alignment=\"se\"\/> <definition>x1 = intersect(tan,-1)<\/definition> <repeat parameter=\"x in (x0, x1)\"> <line endpoints=\"((x,0),(x,0))\" endpoint-offsets=\"((0,-3),(0,3))\" tactile-endpoint-offsets=\"((0,-18),(0,0))\" stroke=\"black\"\/> <\/repeat> <label anchor=\"(x0,0)\" alignment=\"north\"> <m>x_0<\/m> <\/label> <label anchor=\"(x1,0)\" alignment=\"ne\"> <m>x_1<\/m> <\/label> <\/coordinates> <\/diagram>   The source for   "
},
{
