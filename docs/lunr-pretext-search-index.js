...
},
{
  ...
  "number": "3.7.23",
  "title": "",
  "body": "    g(x,y)=x*y  del_g(x,y)=grad(g, (x,y))     ds(t)=deriv(s,t)  T(t)=1\/length(ds(t))*ds(t)    p=s(3)  g=0.2*del_g(p[0],p[1])   {\\mathbf T}    \\nabla f    \\theta       The gradient of a function plotted along a <spline> .  "
},
{
