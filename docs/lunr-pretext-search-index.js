...
},
{
  ...
  "number": "3.9.4",
  "title": "",
  "body": "    Using different features to define the network structure.  "
},
{
  ...
  "number": "3.9.5",
  "title": "",
  "body": "  <diagram dimensions=\"(250,250)\" margins=\"5\"> <coordinates bbox=\"(-1,-1,1,1)\"> <definition>graph={0:[0,1], 1:[0]}<\/definition> <network directed=\"yes\" graph=\"graph\" arrows=\"middle\" seed=\"1\" node-size=\"15\" scale=\"0.5\" node-fill=\"white\" labels=\"yes\"> <node at=\"2\" style=\"double-circle\"><m>S<\/m><\/node> <edge vertices=\"(2,2)\">1<\/edge> <edge vertices=\"(2,1)\"\/> <edge vertices=\"(2,0)\"\/> <edge vertices=\"(0,0)\" label-location=\"0.6\">1<\/edge> <\/network> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
