...
},
{
  ...
  "body": "  <diagram dimensions=\"(300, 300)\" margins=\"5\"> <definition> a=1 <\/definition> <definition> f(x) = exp(x\/3)*cos(x) <\/definition> <coordinates bbox=\"[-4,-4,4,4]\"> <grid-axes xlabel=\"x\" ylabel=\"y\"\/> <graph at=\"graph\" function='f' \/> <tangent-line at=\"tangent\" function=\"f\" point=\"a\"\/> <point at=\"point\" p=\"(a, f(a))\"> <m>(a,f(a))<\/m> <\/point> <\/coordinates> <annotations text=\"The graph of a function and its tangent line at the point a equals 1\"> <annotation ref=\"graph-tangent\" text=\"The graph and its tangent line\"> <annotation ref=\"graph\" text=\"The graph of the function f\" sonify=\"yes\"\/> <annotation ref=\"point\" text=\"The point a comma f of a\"\/> <annotation ref=\"tangent\" text=\"The tangent line to the graph of f at the point\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for the annotated diagram  "
},
{
...
},
{
  ...
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x)=x^3-3*x+1<\/definition> <derivative name=\"fp\" function=\"f\"\/> <coordinates bbox=\"(-3,-3,3,3)\"> <grid-axes\/> <graph function=\"f\"\/> <graph function=\"fp\" stroke=\"green\"\/> <label anchor=\"(1.8,f(1.8))\" alignment=\"se\"><m>f(x)<\/m><\/label> <label anchor=\"(0.5,fp(0.5))\" alignment=\"se\"><m>f'(x)<\/m><\/label> <\/coordinates> <\/diagram>   The PreFigure source for   "
},
{
...
{
  "id": "diagram-fill-pattern",
  "level": "2",
  "url": "sec-graphical-attr.html#diagram-fill-pattern",
  "type": "Figure",
  "number": "3.1.11",
  "title": "",
  "body": "    f(k)=2.5*(cos(2*pi*k\/6), sin(2*pi*k\/6))                  Shapes filled with the fill-pattern attribute.  "
},
{
  "id": "listing-fill-pattern",
  "level": "2",
  "url": "sec-graphical-attr.html#listing-fill-pattern",
  "type": "Listing",
  "number": "3.1.12",
  "title": "The PreFigure source for Figure 3.1.11.",
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <definition>f(k)=2.5*(cos(2*pi*k\/6), sin(2*pi*k\/6))<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <axes decorations=\"no\"\/> <circle center=\"f(0)\" radius=\"1\" stroke=\"blue\" fill-pattern=\"horizontal\" fill=\"orange\"\/> <circle center=\"f(1)\" radius=\"1\" stroke=\"blue\" fill-pattern=\"vertical\" fill=\"red\"\/> <circle center=\"f(2)\" radius=\"1\" stroke=\"blue\" fill-pattern=\"diagonal\" fill=\"magenta\"\/> <define-shapes> <circle at=\"c4\" center=\"f(3)\" radius=\"1\"\/> <\/define-shapes> <shape shape=\"c4\" fill=\"white\"\/> <shape shape=\"c4\" stroke=\"blue\" fill-pattern=\"backdiagonal\" fill=\"rgb(127, 127, 0)\"\/> <circle center=\"f(4)\" radius=\"1\" stroke=\"blue\" fill-pattern=\"dot\" fill=\"#777\"\/> <circle center=\"f(5)\" radius=\"1\" stroke=\"blue\" fill-pattern=\"diamond\" fill=\"blue\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "sec-outlining",
  "level": "1",
...
},
{
  ...
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(y,t)=t-y<\/definition> <coordinates bbox=\"(-1,-1,4,4)\"> <grid-axes\/> <group outline=\"always\"> <plot-de-solution function=\"f\" t0=\"0\" y0=\"0\" outline=\"yes\"\/> <plot-de-solution function=\"f\" t0=\"0\" y0=\"2\" outline=\"yes\"\/> <\/group> <point p=\"(0,2)\"\/> <point p=\"(0,0)\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  ...
  "number": "3.2.7",
  "title": "",
  "body": "  <group at=\"line-L1\"> <line endpoints=\"((-2,1),(2,2))\"\/> <label anchor=\"(2,2)\"> <m>L_1<\/m> <\/label> <\/group> ... <annotations text=\"high level description\"> ... <annotation ref=\"line-L1\" text=\"The first line\"\/> ... <\/annotations>   "
},
{
  "id": "sec-grid-axes",
  "level": "1",
...
},
{
  ...
  "type": "Listing",
  "number": "3.4.4",
  "title": "The PreFigure source for Figure 3.4.3.",
...
},
{
  "id": "diagram-fonts",
  "level": "2",
  "url": "sec-labels.html#diagram-fonts",
  "type": "Figure",
  "number": "3.4.7",
  "title": "",
  "body": "         Serif  Sans-serif   Monospace   Point label  Monospace default      Fonts can be chosen with the font attribute and the size of the font with font-size .  "
},
{
  "id": "listing-fonts",
  "level": "2",
  "url": "sec-labels.html#listing-fonts",
  "type": "Listing",
  "number": "3.4.8",
  "title": "The PreFigure source for Figure 3.4.7.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <templates> <label font=\"monospace\" font-size=\"24\"\/> <\/templates> <coordinates bbox=\"(0,0,10,10)\"> <grid\/> <label font=\"serif\" font-size=\"20\" alignment=\"c\" anchor=\"(3,9)\"> Serif <\/label> <label font=\"sans-serif\" font-size=\"18\" alignment=\"w\" anchor=\"(8,7)\"> Sans-serif <\/label> <label font=\"monospace\" font-size=\"24\" alignment=\"sw\" anchor=\"(7,6)\"> <b>Monospace<\/b> <\/label> <point p=\"(2,4)\" alignment=\"se\"> Point label <\/point> <label anchor=\"(10,1)\" alignment=\"nw\"> Monospace default <\/label> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "3.4.12",
  "title": "The PreFigure source for Figure 3.4.11.",
...
},
{
  ...
  "body": "  <diagram dimensions=\"(300, 300)\" margins=\"5\"> <coordinates bbox=\"(0,0,5,5)\"> <grid\/> <line endpoints=\"((1,4), (4,4.5))\" stroke=\"blue\" thickness=\"5\" arrows=\"1\"\/> <line p1=\"(1,3)\" p2=\"(4,2.5)\" stroke=\"lightgray\" thickness=\"20\"\/> <line p1=\"(1,3)\" p2=\"(4,2.5)\" endpoint-offsets=\"(10, -5)\" thickness=\"5\"\/> <line endpoints=\"((1,1.5),(4,2))\" stroke=\"green\" infinite=\"yes\"\/> <definition>p1=(1,1)<\/definition> <definition>p2=(4.5,0.5)<\/definition> <line endpoints=\"(p1,p2)\" endpoint-offsets=\"((10,0), (-10,0))\"\/> <label anchor=\"p1\" clear-background=\"yes\"><m>a<\/m><\/label> <label anchor=\"p2\" clear-background=\"yes\"><m>b<\/m><\/label> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "diagram-line-decorations",
  "level": "2",
  "url": "sec-simple.html#diagram-line-decorations",
  "type": "Figure",
  "number": "3.5.5",
  "title": "",
  "body": " Decorations on lines.              "
},
{
  "id": "listing-line-decorations",
  "level": "2",
  "url": "sec-simple.html#listing-line-decorations",
  "type": "Listing",
  "number": "3.5.6",
  "title": "The PreFigure source for Figure 3.5.5.",
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <coordinates bbox=\"(0,0,10,10)\"> <grid\/> <line endpoints=\"((1,9),(9,9))\" decorations=\"(]\"\/> <line endpoints=\"((1,5),(9,7))\" decorations=\"[]\" stroke=\"blue\" thickness=\"4\"\/> <line endpoints=\"((1,3),(9,1))\" decorations=\")\" arrows=\"2\" stroke=\"red\" additional-arrows=\"0.5\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
...
{
  "id": "diagram-line-labels",
  "level": "2",
  "url": "sec-simple.html#diagram-line-labels",
  "type": "Figure",
  "number": "3.5.9",
  "title": "",
  "body": "       x+y=14    x+6y=14   a line      Labels applied to lines.  "
},
{
  "id": "listing-line-labels",
  "level": "2",
  "url": "sec-simple.html#listing-line-labels",
  "type": "Listing",
  "number": "3.5.10",
  "title": "The PreFigure source for Figure 3.5.9.",
  "body": "  <diagram dimensions=\"(400, 250)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <coordinates bbox=\"(0,0,10,10)\"> <grid-axes decorations=\"no\"\/> <line endpoints=\"((5,9),(9,5))\" offset=\"(0,10)\" clear-background=\"yes\"> <m>x+y=14<\/m> <\/line> <line endpoints=\"((2,2),(8,1))\" label-location=\"0.3\"> <m>x+6y=14<\/m> <\/line> <line endpoints=\"((4,10),(1,5))\" label-location=\"-0.3\" clear-background=\"yes\" infinite=\"yes\"> a line <\/line> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "diagram-vectors",
  "level": "2",
...
},
{
  ...
  "type": "Listing",
  "number": "3.5.12",
  "title": "The PreFigure source for Figure 3.5.11.",
  "body": "  <diagram dimensions=\"(300, 300)\" margins=\"5\"> <coordinates bbox=\"(-1,-1,5,5)\"> <grid-axes decorations=\"no\"\/> <vector v=\"(3,4)\"\/> <vector v=\"(1,3\/2)\" tail=\"(2,1)\" scale-length=\"2\" stroke=\"blue\"\/> <vector v=\"(1,3)\" tail=\"(3.5,1)\" head-location=\"0.8\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "diagram-vector-labels",
  "level": "2",
  "url": "sec-simple.html#diagram-vector-labels",
  "type": "Figure",
  "number": "3.5.13",
  "title": "",
  "body": "    v1=(2,1)  v2=(1,2)       {\\mathbf v}_1    {\\mathbf v}_2       Labels attached to Vectors.  "
},
{
  "id": "listing-vector-labels",
  "level": "2",
  "url": "sec-simple.html#listing-vector-labels",
  "type": "Listing",
  "number": "3.5.14",
  "title": "The PreFigure source for Figure 3.5.13.",
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <definition>v1=(2,1)<\/definition> <definition>v2=(1,2)<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid spacings=\"((-6,2,6),(-6,2,6))\" stroke=\"#ddd\"\/> <grid basis=\"(v1,v2)\" stroke=\"lightgray\"\/> <axes decorations=\"no\"\/> <vector v=\"v1\" alignment=\"se\"> <m>{\\mathbf v}_1<\/m> <\/vector> <vector v=\"v2\" alignment=\"nw\"> <m>{\\mathbf v}_2<\/m> <\/vector> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "3.5.19",
  "title": "The PreFigure source for Figure 3.5.18.",
...
},
{
  ...
  "type": "Listing",
  "number": "3.5.21",
  "title": "The PreFigure source for Figure 3.5.20.",
...
},
{
  ...
  "type": "Listing",
  "number": "3.5.23",
  "title": "The PreFigure source for Figure 3.5.22.",
...
},
{
  ...
  "body": " Calculus components   There is a collection of graphical components to facilitate diagrams that could appear in a calculus or precalculus course.    Graphs, derivatives, and tangent lines  To include the graph of a function, the function first needs to be defined inside a <definition> . By default, the domain of the function is assumed to be the horizontal extend of the current bounding box. The domain attribute can modify this, however.      The graphs of two functions.     <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x)=x^3\/8 - 1.5*x<\/definition> <definition>g(s)=-sqrt(s+2)-1<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid-axes decorations=\"no\"\/> <graph function=\"f\"\/> <graph function=\"g\" domain=\"(-2,5)\" stroke=\"green\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .   By default, a graph is drawn by connecting N=\"100\" short line segments. You may sometimes need to increase N if the graph varies a lot.  As demonstrated in , the deriv function can be used to define the derivative of a function. For instance, fp(x) = deriv(f, x) defines fp to be the derivative.  Tangent lines are similar except a point attribute should be included to define the point at which the tangent line will appear. As with functions, the tangent line will be drawn across the length of the bounding box unless modified using the domain attribute.      A graph with tangent lines.     <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x)=x^3\/8 - 1.5*x<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid-axes decorations=\"no\"\/> <graph function=\"f\"\/> <tangent-line function=\"f\" point=\"-1.5\"\/> <tangent-line function=\"f\" point=\"1.5\" domain=\"(0,3)\" stroke=\"green\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .   A <tangent-line> element can be given a name attribute so that one might refer later to the linear function that defines the tangent line. For instance, if name=\"L\" , then L defines the function . demonstrates this feature by illustrating one step of Newton's method.      f(x)=7-(x+1)^2\/2  x0 = 1       x1 = intersect(tan,-1)      x_0    x_1       An author can reference the linear function defined by a <tangent-line> .   Note the use of the intersect function in the source. In this case, intersect(L, -1) finds the solution of the equation using as a starting point. In the same way, solve(f, y, x0) finds the solution of the equation using as a starting point.    <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x)=7-(x+1)^2\/2<\/definition> <definition>x0 = 1<\/definition> <coordinates bbox=\"(-8,-8,8,8)\"> <grid-axes xlabel=\"x\" ylabel=\"y\"\/> <graph function=\"f\"\/> <tangent-line function=\"f\" point=\"x0\" name=\"L\"\/> <point p=\"(x0,f(x0))\" alignment=\"se\"\/> <definition>x1 = intersect(L,-1)<\/definition> <repeat parameter=\"x in (x0, x1)\"> <line endpoints=\"((x,0),(x,0))\" endpoint-offsets=\"((0,-3),(0,3))\" tactile-endpoint-offsets=\"((0,-18),(0,0))\" stroke=\"black\"\/> <\/repeat> <label anchor=\"(x0,0)\" alignment=\"north\"> <m>x_0<\/m> <\/label> <label anchor=\"(x1,0)\" alignment=\"ne\"> <m>x_1<\/m> <\/label> <\/coordinates> <\/diagram>   The PreFigure source for .   It is possible to include arrows on the right and\/or left ends of a <graph> using either arrows=\"1\" or \"2\" though this practice is discouraged due to the visual clutter it can create.    Parametric curves  The <parametric-curve> tag includes the plot of a function defined parametrically.      Two parametric curves.     <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(t)=3*(cos(t), sin(t)) + (cos(10*t),sin(10*t))<\/definition> <definition>g(t)=(t^2,t^3)<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid-axes decorations=\"no\"\/> <parametric-curve function=\"f\" domain=\"(0,2*pi)\" N=\"200\" closed=\"yes\"\/> <parametric-curve function=\"g\" domain=\"(-2,2)\" stroke=\"red\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .   Notice that a parametric curves needs a domain attribute and may be closed with closed=\"yes\" . Some curves may require a larger value of N for a smoother appearence.  Arrows can be added to a <parametric-curve> . For instance, arrows=\"1\" adds an arrow at the end of the curve, and arrows=\"2\" adds arrows at both ends. To include an arrow in the middle of the curve, use the attribute arrow-location whose value is a point in the domain where the arrow should appear.    Implicit curves  The solutions to an equation can be plotted with the <implicit-curve> and <contour> tags. These tags are functionally equivalent and are both provided since one may be more aligned with an author's intent in a given context.      Two implicit curves defined by      <diagram dimensions=\"(300, 300)\" margins=\"5\"> <definition>f(x,y) = y^2 - x^3 + x<\/definition> <coordinates bbox=\"[-2,-2,2,2]\"> <grid-axes \/> <implicit-curve function=\"f\" k=\"-1\" stroke=\"orange\" \/> <implicit-curve function=\"f\" k=\"1\" stroke=\"orange\" \/> <\/coordinates> <\/diagram>   The PreFigure source for .   Two required attributes are function and k . The algorithm relies on breaking the current bounding box into smaller rectangles and looking for solutions to recursively. For some complicated functions, the algorithm may miss a component of the curve. In this case, set the attribute initial-depth to a value higher than its default of 4. If two components are incorrectly joined, increase the depth to which the algorithm may recurse by raising depth beyond its default of 8.    Areas  The area under a curve and between curves are drawn with <area-under-curve> and <area-between-curves> .       The area under a curve and between two curves     <diagram dimensions=\"(300, 300)\" margins=\"5\"> <definition>f(x)=2*sqrt(x)<\/definition> <coordinates bbox=\"[-1,-1,5,5]\"> <grid-axes \/> <area-under-curve function=\"f\" domain=\"(1,4)\" fill=\"lightgray\" stroke=\"black\"\/> <graph function=\"f\" domain=\"(0,5)\"\/> <\/coordinates> <\/diagram>    <diagram dimensions=\"(300, 300)\" margins=\"5\"> <definition>f(x)=sqrt(x)<\/definition> <definition>g(x)=-2*atan(x)<\/definition> <coordinates bbox=\"[-1,-3,5,3]\"> <grid-axes \/> <area-between-curves function1=\"f\" function2=\"g\" domain=\"(1,3)\" fill=\"lightgray\" stroke=\"black\"\/> <graph function=\"f\" domain=\"(0,5)\"\/> <graph function=\"g\" domain=\"(0,5)\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagrams in .   As with the other graphs we have seen in this section, the value of N can be increased to produce smoother graphs, in some cases.  As demonstrated in , there is another version of the intersect function that can be helpful.      f(x)=sin(x)  g(x)=cos(x)  a=intersect((f,g),1)  b=intersect((f,g),4)         a     b       The intersect function finds the intersection of two graphs.   In this case, we use intersect( (f,g), 1) to find the intersection point starting with . Notice that the two functions are included inside parentheses.    <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x)=sin(x)<\/definition> <definition>g(x)=cos(x)<\/definition> <definition>a=intersect((f,g),1)<\/definition> <definition>b=intersect((f,g),4)<\/definition> <coordinates bbox=\"(-1,-1.5,5,1.5)\"> <grid-axes decorations=\"no\"\/> <area-between-curves functions=\"(f,g)\" domain=\"(a,b)\" fill=\"lightgray\"\/> <graph function=\"f\"\/> <graph function=\"g\"\/> <line endpoints=\"((a,0),(a,0))\" endpoint-offsets=\"((0,-3),(0,3))\"\/> <label anchor=\"(a,0)\" alignment=\"south\" offset=\"(0,-7)\"> <m>a<\/m> <\/label> <line endpoints=\"((b,0),(b,0))\" endpoint-offsets=\"((0,-3),(0,3))\"\/> <label anchor=\"(b,0)\" alignment=\"south\" offset=\"(0,-4)\"> <m>b<\/m> <\/label> <\/coordinates> <\/diagram>   The PreFigure source for .     Riemann sums  The <riemann-sum> element provides some flexibility for illustrating a Riemann sum. , and the following source, offer a demonstration.      A Riemann sum     <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x) = 2*log(x+2)<\/definition> <coordinates bbox=\"[-1,-1,5,5]\"> <grid-axes\/> <riemann-sum function=\"f\" domain=\"(1,4)\" rule=\"right\" N=\"6\" fill=\"lawngreen\" stroke=\"black\"\/> <graph function=\"f\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .   There are two ways to specify the subintervals of the Riemann sum. As shown in , one may state the number of subintervals with the attribute N . The domain attribute allows one to declare the bounds of the sum. If N is defined without domain , then the domain is given by the bounding box.  Alternatively, one may specify the subintervals with the partition attribute. For instance, partition=\"(1, 1.5, 2.5, 3, 4)\" defines four subintervals of varying width.  The rule attribute declares how the terms in the Riemann sum are to be constructed. Possible values are left , right , midpoint , upper , lower , trapezoidal , and simpsons . Alternatively, one may explicity state the values at which the function is to be sampled with the samples , such as samples=\"(1, 2, 2.75, 3.2)\" . The number of samples given should equal the number of subintervals.  The <riemann-sum> element will generate several graphical components, one for each subinterval. As a result, there are some special attributes provided to facilitate annotating these elements. (More details about annotating diagrams are available in .)  To annotate a <riemann-sum> , include the attribute annotate=\"yes\" . Then the value of the text attribute is vocalized in an annotation that gives an overview of the entire Riemann sum.  The text associated with each of the subintervals is given by the attribute subinterval-text . Some data about each of the subintervals is stored in the variables: _interval , which gives the number of the current subinterval; _left and _right , which give the bounds of the subinterval, and _height , which gives the height of the rectangle when the value of rule is not trapezoidal or simpsons .       f(x) = 2*exp(x\/4)*sin(2*x)   ordinals=('first', 'second', 'third', 'fourth', 'fifth', 'sixth')            An annotated Riemann sum     <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <coordinates bbox=\"(-4,-4,4,4)\"> <definition>f(x) = 2*exp(x\/4)*sin(2*x)<\/definition> <grid-axes decorations=\"no\"\/> <definition> ordinals=('first', 'second', 'third', 'fourth', 'fifth', 'sixth') <\/definition> <riemann-sum at=\"rs\" function=\"f\" fill=\"lightblue\" stroke=\"black\" partition=\"(-3, -2, -1.5, -1, 0.5, 2, 3)\" samples=\"(-2.5, -2, -1.2, 0.2, 1, 2.8)\" miterlimit=\"1\" annotate=\"yes\" circular=\"yes\" text=\"A Riemann sum for the function f over the interval from -3 to 3 with six subintervals defined by the partition attribute.\" subinterval-text=\"The ${ordinals[_interval]} interval starts at x=${_left} and ends at x=${_right} with height ${_height}\"\/> <graph at=\"graph\" function=\"f\"\/> <\/coordinates> <annotations text=\"This diagram demonstrates how to annotate a Riemann sum\"> <annotation ref=\"graph\" text=\"The graph of the function f\" sonify=\"yes\"\/> <annotation ref=\"rs\"\/> <\/annotations> <\/diagram>   The PreFigure source for the diagram in .     Vector fields and gradients  can plot two-dimensional vector fields and gradients of two-variable functions as demonstrated in the next series of examples.      f(x,y)=(-y,x)            The vector field     <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x,y)=(-y,x)<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid-axes\/> <repeat parameter=\"k=1..6\"> <circle center=\"(0,0)\" radius=\"k\" stroke=\"orange\"\/> <\/repeat> <vector-field function=\"f\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .   Notice that the vector field is defined by the value of the function attribute. The grid on which the vector field is drawn can be changed using the spacings attribute similar to that of the grid element .  If the lengths of some of the vectors exceed the size of a cell in the grid, then all the vectors will be scaled by some appropriate factor. This behavior can be changed by setting the scale attribute so that the vector field plotted is where is the value of the scale attribute.  The size and shape of arrows can be controlled using arrow-width and arrow-angles as described in the section on arrows.  Illustrating vector fields can be challenging when there is considerable variation in the lengths of the vectors. For this reason, one may add an exponent=\"p\" attribute to the <vector-field> element. This causes a vector to be scaled so that its new length is . With a value of , the lengths will become more uniform, as demonstrated in , which can help some features, such as critical points and circulation, to appear more easily.       F(x,y)=(x*y,1-x)    x  y           F(x,y)=(x*y,1-x)    x  y         The vector field shown on the left is redrawn on the right with exponent=\"0.3\" .   The gradient of a function can be defined using the grad operator. For instance, del_f(x,y) = grad(f, (x,y)) defines a new function which is the gradient of f . Notice that the point (x,y) is enclosed in parentheses inside the grad operator.      f(x,y)=x^2+y^2  del_f(x,y)=grad(f, (x,y))            The gradient of the function .     <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>f(x,y)=x^2+y^2<\/definition> <definition>del_f(x,y) = grad(f, (x,y))<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid-axes stroke=\"gray\"\/> <repeat parameter=\"k=1..6\"> <circle center=\"(0,0)\" radius=\"k\" stroke=\"orange\"\/> <\/repeat> <vector-field function=\"del_f\" spacings=\"((-3,1,3),(-3,1,3))\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .   Alternatively, one can plot a vector field along a curve by modifying the attributes of the <vector-field> element. If a function is defined, then we can include the attributes curve=\"r\" , domain=\"(a,b)\" , and N=\"n\" to plot the vector field times across the domain .      F(x,y)=(y,x)  r1(t)=(3*cos(t),3*sin(t))          A vector field plotted along a curve.     <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>F(x,y)=(y,x)<\/definition> <definition>r1(t)=(3*cos(t),3*sin(t))<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid-axes decorations=\"no\"\/> <parametric-curve function=\"r1\" domain=\"(0,2*pi)\" stroke=\"magenta\"\/> <vector-field function=\"F\" curve=\"r1\" domain=\"(0,2*pi)\" N=\"13\" scale=\"0.4\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .   Notice that a <spline> can be given a name attribute to define a parametric curve.      g(x,y)=x*y  del_g(x,y)=grad(g, (x,y))     ds(t)=deriv(s,t)  T(t)=1\/length(ds(t))*ds(t)    p=s(3)  g=0.2*del_g(*p)   {\\mathbf T}    \\nabla f    \\theta       The gradient of a function plotted along a <spline> .     <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>g(x,y)=x*y<\/definition> <definition>del_g(x,y)=grad(g, (x,y))<\/definition> <coordinates bbox=\"(-1,-1,4,4)\"> <grid-axes decorations=\"no\" spacings=\"((-1,1,4),(-1,1,4))\"\/> <spline points=\"((-0.5,3),(1,3),(2,2.5),(3,1.5),(2,0))\" name=\"s\" stroke=\"magenta\" thickness=\"2\"\/> <definition>ds(t)=deriv(s,t)<\/definition> <definition>T(t)=1\/length(ds(t))*ds(t)<\/definition> <vector-field function=\"T\" curve=\"s\" domain=\"(0,4)\" N=\"5\"\/> <vector-field function=\"del_g\" curve=\"s\" domain=\"(0,4)\" N=\"5\" scale=\"0.2\"\/> <definition>p=s(3)<\/definition> <definition>g=0.2*del_g(*p)<\/definition> <label anchor=\"p+T(3)\" alignment=\"se\"> <m>{\\mathbf T}<\/m> <\/label> <label anchor=\"p+g\" alignment=\"n\"> <m>\\nabla f<\/m> <\/label> <angle-marker points=\"(p+T(3),p,p+g)\"> <m>\\theta<\/m> <\/angle-marker> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .   Note the use of the * operator as described in . Alternatively, one could have written g=del_g(p[0],p[1]) .    Polar coordinates  There are a few components that we have already met and that can be adapted for use in polar coordinates. These include  <grid>  <grid-axes>  <graph>  <area-under-curve>  <area-between-curves>    demonstrates some examples of polar grids. The grid on the left is formed simply by adding coordinates=\"polar\" to the <grid-axes> element. In this case, the spacings of the grid lines are automatically determined. The radial spacing is determined by the size of the bounding box while the angular spacing gives a separation of in the grid lines drawn radially.   Polar grids are created by adding coordinates=\"polar\" to either a <grid> or <grid-axes> elements.                        The diagram on the right of shows two polar grids with the spacings of the grid lines specified in the source, which is given in . Notice that the spacings attribute is used with the first triplet describing the radial spacing and the second triplet describing the angular spacing. By default, the angular spacing is expected to be expressed in radians, but this can be modified with spacing-degrees=\"yes\" .    <diagram dimensions=\"(300,300)\" margins=\"5\"> <coordinates bbox=\"(-5,-5,5,5)\"> <grid coordinates=\"polar\" spacings=\"((0,0.5,5),(0,15,360))\" spacing-degrees=\"yes\" stroke=\"lightgray\"\/> <grid coordinates=\"polar\" spacings=\"((0,1,5),(0,30,360))\" spacing-degrees=\"yes\" stroke=\"gray\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram on the right of .   The coordinates of a <point> may be given in polar coordinates by using the attribute coordinates=\"polar\" . By default, the polar angle is assumed to be in radians, but this can be changed with degrees=\"yes\" . Similarly, graphs of polar functions can be added to a diagram using a <graph> element with the attribute coordinates=\"polar\" , as illustrated in and its source in .   Graphing polar curves     f(t)=4*sin(3*t)  g(t)=0.5*e^(0.3*t)            By default, the domain of a polar graph is , but another domain can be specified using the domain and domain-degrees attributes. Polar graphs can also be closed with closed=\"yes\" and filled.    <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>f(t)=4*sin(3*t)<\/definition> <definition>g(t)=0.5*e^(0.3*t)<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid-axes coordinates=\"polar\" clear-background=\"yes\"\/> <graph function=\"f\" coordinates=\"polar\" closed=\"yes\" fill=\"cornflowerblue\"\/> <graph function=\"g\" coordinates=\"polar\" arrows=\"1\" domain=\"(-360,360)\" domain-degrees=\"yes\" stroke=\"red\" thickness=\"4\"\/> <point p=\"(4,60)\" coordinates=\"polar\" degrees=\"yes\" size=\"5\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .   Polar areas can also be included using area-under-curve and area-between-curves by adding the coordinates=\"polar\" attribute. This is illustrated in    Illustrating polar areas     f(t)=4*cos(2*t)  g(t)=2+cos(3*t)              <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(t)=4*cos(2*t)<\/definition> <definition>g(t)=2+cos(3*t)<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid-axes coordinates=\"polar\" clear-background=\"yes\"\/> <graph function=\"g\" coordinates=\"polar\" stroke=\"gray\" domain=\"(90,270)\" domain-degrees=\"yes\"\/> <area-under-curve function=\"f\" coordinates=\"polar\" domain=\"(-30,30)\" domain-degrees=\"yes\" fill=\"cornflowerblue\" stroke=\"blue\"\/> <area-between-curves functions=\"(f,g)\" coordinates=\"polar\" domain=\"(150,210)\" domain-degrees=\"yes\" fill=\"orange\" stroke=\"red\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .    "
},
{
  "id": "diagram-graph",
  "level": "2",
...
},
{
  ...
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x) = 2*log(x+2)<\/definition> <coordinates bbox=\"[-1,-1,5,5]\"> <grid-axes\/> <riemann-sum function=\"f\" domain=\"(1,4)\" rule=\"right\" N=\"6\" fill=\"lawngreen\" stroke=\"black\"\/> <graph function=\"f\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .  "
},
{
  "id": "diagram-riemann-sum-annotated",
  "level": "2",
  "url": "sec-calculus.html#diagram-riemann-sum-annotated",
  "type": "Figure",
  "number": "3.7.17",
  "title": "",
  "body": "     f(x) = 2*exp(x\/4)*sin(2*x)   ordinals=('first', 'second', 'third', 'fourth', 'fifth', 'sixth')            An annotated Riemann sum  "
},
{
  "id": "listing-riemann-sum-annotated",
  "level": "2",
  "url": "sec-calculus.html#listing-riemann-sum-annotated",
  "type": "Listing",
  "number": "3.7.18",
  "title": "The PreFigure source for the diagram in Figure 3.7.17.",
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <coordinates bbox=\"(-4,-4,4,4)\"> <definition>f(x) = 2*exp(x\/4)*sin(2*x)<\/definition> <grid-axes decorations=\"no\"\/> <definition> ordinals=('first', 'second', 'third', 'fourth', 'fifth', 'sixth') <\/definition> <riemann-sum at=\"rs\" function=\"f\" fill=\"lightblue\" stroke=\"black\" partition=\"(-3, -2, -1.5, -1, 0.5, 2, 3)\" samples=\"(-2.5, -2, -1.2, 0.2, 1, 2.8)\" miterlimit=\"1\" annotate=\"yes\" circular=\"yes\" text=\"A Riemann sum for the function f over the interval from -3 to 3 with six subintervals defined by the partition attribute.\" subinterval-text=\"The ${ordinals[_interval]} interval starts at x=${_left} and ends at x=${_right} with height ${_height}\"\/> <graph at=\"graph\" function=\"f\"\/> <\/coordinates> <annotations text=\"This diagram demonstrates how to annotate a Riemann sum\"> <annotation ref=\"graph\" text=\"The graph of the function f\" sonify=\"yes\"\/> <annotation ref=\"rs\"\/> <\/annotations> <\/diagram>   The PreFigure source for the diagram in .  "
},
{
  "id": "diagram-vector-field",
  "level": "2",
  "url": "sec-calculus.html#diagram-vector-field",
  "type": "Figure",
  "number": "3.7.19",
  "title": "",
  "body": "    f(x,y)=(-y,x)            The vector field  "
},
{
  "id": "listing-vector-field",
  "level": "2",
  "url": "sec-calculus.html#listing-vector-field",
  "type": "Listing",
  "number": "3.7.20",
  "title": "The PreFigure source for the diagram in Figure 3.7.19.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition>f(x,y)=(-y,x)<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid-axes\/> <repeat parameter=\"k=1..6\"> <circle center=\"(0,0)\" radius=\"k\" stroke=\"orange\"\/> <\/repeat> <vector-field function=\"f\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .  "
},
{
  "id": "diagram-vector-exponent",
  "level": "2",
  "url": "sec-calculus.html#diagram-vector-exponent",
  "type": "Figure",
  "number": "3.7.21",
  "title": "",
  "body": "     F(x,y)=(x*y,1-x)    x  y           F(x,y)=(x*y,1-x)    x  y         The vector field shown on the left is redrawn on the right with exponent=\"0.3\" .  "
},
{
  "id": "diagram-gradient",
  "level": "2",
  "url": "sec-calculus.html#diagram-gradient",
  "type": "Figure",
  "number": "3.7.22",
  "title": "",
  "body": "    f(x,y)=x^2+y^2  del_f(x,y)=grad(f, (x,y))            The gradient of the function .  "
},
{
  "id": "listing-gradient",
  "level": "2",
  "url": "sec-calculus.html#listing-gradient",
  "type": "Listing",
  "number": "3.7.23",
  "title": "The PreFigure source for the diagram in Figure 3.7.22.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>f(x,y)=x^2+y^2<\/definition> <definition>del_f(x,y) = grad(f, (x,y))<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid-axes stroke=\"gray\"\/> <repeat parameter=\"k=1..6\"> <circle center=\"(0,0)\" radius=\"k\" stroke=\"orange\"\/> <\/repeat> <vector-field function=\"del_f\" spacings=\"((-3,1,3),(-3,1,3))\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .  "
},
{
  "id": "diagram-vec-field",
  "level": "2",
  "url": "sec-calculus.html#diagram-vec-field",
  "type": "Figure",
  "number": "3.7.24",
  "title": "",
  "body": "    F(x,y)=(y,x)  r1(t)=(3*cos(t),3*sin(t))          A vector field plotted along a curve.  "
},
{
  "id": "listing-vec-field",
  "level": "2",
  "url": "sec-calculus.html#listing-vec-field",
  "type": "Listing",
  "number": "3.7.25",
  "title": "The PreFigure source for the diagram in Figure 3.7.24.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>F(x,y)=(y,x)<\/definition> <definition>r1(t)=(3*cos(t),3*sin(t))<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid-axes decorations=\"no\"\/> <parametric-curve function=\"r1\" domain=\"(0,2*pi)\" stroke=\"magenta\"\/> <vector-field function=\"F\" curve=\"r1\" domain=\"(0,2*pi)\" N=\"13\" scale=\"0.4\"\/> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .  "
},
{
  "id": "diagram-grad-field",
  "level": "2",
  "url": "sec-calculus.html#diagram-grad-field",
  "type": "Figure",
  "number": "3.7.26",
  "title": "",
  "body": "    g(x,y)=x*y  del_g(x,y)=grad(g, (x,y))     ds(t)=deriv(s,t)  T(t)=1\/length(ds(t))*ds(t)    p=s(3)  g=0.2*del_g(*p)   {\\mathbf T}    \\nabla f    \\theta       The gradient of a function plotted along a <spline> .  "
},
{
  "id": "listing-grad-field",
  "level": "2",
  "url": "sec-calculus.html#listing-grad-field",
  "type": "Listing",
  "number": "3.7.27",
  "title": "The PreFigure source for the diagram in Figure 3.7.26.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>g(x,y)=x*y<\/definition> <definition>del_g(x,y)=grad(g, (x,y))<\/definition> <coordinates bbox=\"(-1,-1,4,4)\"> <grid-axes decorations=\"no\" spacings=\"((-1,1,4),(-1,1,4))\"\/> <spline points=\"((-0.5,3),(1,3),(2,2.5),(3,1.5),(2,0))\" name=\"s\" stroke=\"magenta\" thickness=\"2\"\/> <definition>ds(t)=deriv(s,t)<\/definition> <definition>T(t)=1\/length(ds(t))*ds(t)<\/definition> <vector-field function=\"T\" curve=\"s\" domain=\"(0,4)\" N=\"5\"\/> <vector-field function=\"del_g\" curve=\"s\" domain=\"(0,4)\" N=\"5\" scale=\"0.2\"\/> <definition>p=s(3)<\/definition> <definition>g=0.2*del_g(*p)<\/definition> <label anchor=\"p+T(3)\" alignment=\"se\"> <m>{\\mathbf T}<\/m> <\/label> <label anchor=\"p+g\" alignment=\"n\"> <m>\\nabla f<\/m> <\/label> <angle-marker points=\"(p+T(3),p,p+g)\"> <m>\\theta<\/m> <\/angle-marker> <\/coordinates> <\/diagram>   The PreFigure source for the diagram in .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "3.7.29",
  "title": "The PreFigure source for the diagram on the right of Figure 3.7.28.",
...
},
{
  ...
  "type": "Listing",
  "number": "3.7.31",
  "title": "The PreFigure source for Figure 3.7.30.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>f(t)=4*sin(3*t)<\/definition> <definition>g(t)=0.5*e^(0.3*t)<\/definition> <coordinates bbox=\"(-5,-5,5,5)\"> <grid-axes coordinates=\"polar\" clear-background=\"yes\"\/> <graph function=\"f\" coordinates=\"polar\" closed=\"yes\" fill=\"cornflowerblue\"\/> <graph function=\"g\" coordinates=\"polar\" arrows=\"1\" domain=\"(-360,360)\" domain-degrees=\"yes\" stroke=\"red\" thickness=\"4\"\/> <point p=\"(4,60)\" coordinates=\"polar\" degrees=\"yes\" size=\"5\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "3.7.33",
  "title": "The PreFigure source for Figure 3.7.32.",
...
{
  "id": "diagram-network-launch",
  "level": "2",
  "url": "sec-networks.html#diagram-network-launch",
  "type": "Figure",
  "number": "3.9.13",
  "title": "",
  "body": " A <network> formed using some <repeat> elements.      angles=(0,20,30,40)         ${l}          "
},
{
  "id": "listing-network-launch",
  "level": "2",
  "url": "sec-networks.html#listing-network-launch",
  "type": "Listing",
  "number": "3.9.14",
  "title": "The PreFigure source for Figure 3.9.13.",
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300,150)\" margins=\"5\"> <coordinates bbox=\"(-0.5,-0.5,4.5,2)\"> <definition>angles=(0,20,30,40)<\/definition> <network directed=\"yes\" labels=\"yes\"> <repeat parameter=\"k=1..5\"> <node at=\"k\" p=\"(k-1,0)\" fill=\"orange\"\/> <\/repeat> <repeat parameter=\"k=0..3\"> <repeat parameter=\"l=0..4-k-1\"> <edge vertices=\"(k+1,k+l+2)\" launch-angle=\"angles[l]\" stroke=\"blue\"> <m>${l}<\/m> <\/edge> <\/repeat> <\/repeat> <\/network> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "3.9.16",
  "title": "The PreFigure source for the left of Figure 3.9.15.",
...
},
{
  ...
  "type": "Listing",
  "number": "3.9.17",
  "title": "The PreFigure source for the right of Figure 3.9.15.",
  "body": "  <diagram dimensions=\"(250,250)\" margins=\"5\"> <definition>graph={1:[3,4,5],2:[4,5],3:[4,5],6:[2,4]}<\/definition> <coordinates bbox=\"(-1,-1,1,1)\"> <network graph=\"graph\" scale=\"0.8\" node-fill=\"#fcf\" node-stroke=\"black\" seed=\"1\" labels=\"yes\" node-style=\"box\" tactile-node-size=\"40\"> <edge vertices=\"[3,5]\" stroke=\"none\"\/> <edge vertices=\"[1,4]\" stroke=\"none\"\/> <edge vertices=\"[4,6]\" stroke=\"none\"\/> <edge vertices=\"[2,4]\" stroke=\"none\"\/> <\/network> <\/coordinates> <\/diagram>   The PreFigure source for the right of .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "3.9.19",
  "title": "The PreFigure source for Figure 3.9.18.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <definition>graph={1:[3,4,5,5],2:[4,5],3:[4,5],6:[2,4]}<\/definition> <network directed=\"yes\" graph=\"graph\" scale=\"0.7\" node-fill=\"#fcf\" node-stroke=\"black\" node-style=\"circle\" node-size=\"15\" arrows=\"end\" seed=\"1\" labels=\"yes\" tactile-node-size=\"45\"> <edge vertices=\"(1,2)\">4<\/edge> <edge vertices=\"(2,2)\" label-location=\"0.3\" loop-scale=\"(0.8,0.8)\"> <m>\\alpha<\/m> <\/edge> <node at=\"2\" style=\"double-circle\"\/> <\/network> <annotations text=\"A directed network with nodes and edges\"> <annotation ref=\"node-1\" text=\"The node 1\"> <annotation ref=\"edge-1-2\" text=\"An edge with label 4 from node 1 to node 2\"\/> <annotation ref=\"edge-1-3\" text=\"An edge from node 1 to node 3\"\/> <annotation ref=\"edge-1-4\" text=\"An edge from node 1 to node 4\"\/> <annotation ref=\"edge-1-5-0\" text=\"An edge from node 1 to node 5\"\/> <annotation ref=\"edge-1-5-1\" text=\"A second edge from node 1 to node 5\"\/> <\/annotation> <annotation ref=\"node-2\" text=\"The node 2\"> <annotation ref=\"edge-2-4\" text=\"An edge from node 2 to node 4\"\/> <annotation ref=\"edge-2-5\" text=\"An edge from node 2 to node 5\"\/> <annotation ref=\"loop-2\" text=\"A loop with label alpha from node 2 to itself\"\/> <\/annotation> <annotation ref=\"node-3\" text=\"The node 3\"> <annotation ref=\"edge-1-3\" text=\"An incoming edge from node 1\"\/> <annotation ref=\"edge-3-4\" text=\"An edge from node 3 to node 4\"\/> <annotation ref=\"edge-3-5\" text=\"An edge from node 3 to node 5\"\/> <\/annotation> <annotation ref=\"node-4\" text=\"The node 4 and four incoming edges\"> <annotation ref=\"edge-1-4\" text=\"An incoming edge from node 1\"\/> <annotation ref=\"edge-2-4\" text=\"An incoming edge from node 2\"\/> <annotation ref=\"edge-3-4\" text=\"An incoming edge from node 3\"\/> <annotation ref=\"edge-6-4\" text=\"An incoming edge from node 6\"\/> <\/annotation> <annotation ref=\"node-5\" text=\"The node 5 and four incoming edges\"> <annotation ref=\"edge-1-5-0\" text=\"An incoming edge from node 1\"\/> <annotation ref=\"edge-1-5-1\" text=\"A second incoming edge from node 1\"\/> <annotation ref=\"edge-2-5\" text=\"An incoming edge from node 2\"\/> <annotation ref=\"edge-3-5\" text=\"An incoming edge from node 3\"\/> <\/annotation> <annotation ref=\"node-6\" text=\"The node 6\"> <annotation ref=\"edge-6-2\" text=\"An edge from node 6 to node 2\"\/> <annotation ref=\"edge-6-4\" text=\"An edge from node 6 to node 4\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "subsec-posets-2",
  "level": "2",
  "url": "sec-networks.html#subsec-posets-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "covers Hasse diagrams, "
},
{
  "id": "diagram-poset-1",
  "level": "2",
  "url": "sec-networks.html#diagram-poset-1",
  "type": "Figure",
  "number": "3.9.20",
  "title": "",
  "body": " A poset whose source is given in .     poset={0:[1,2,3], 1:[4,5], 2:[4,6], 3:[5,6], 4:[7], 5:[7], 6:[7]}             "
},
{
  "id": "listing-poset-1",
  "level": "2",
  "url": "sec-networks.html#listing-poset-1",
  "type": "Listing",
  "number": "3.9.21",
  "title": "The PreFigure source for Figure 3.9.20.",
  "body": " The PreFigure source for .   <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"15\"> <definition> poset={0:[1,2,3], 1:[4,5], 2:[4,6], 3:[5,6], 4:[7], 5:[7], 6:[7]} <\/definition> <poset covers=\"poset\" labeled=\"yes\" node-size=\"12\"\/> <annotations text=\"A simple poset\"> <annotation ref=\"0\" text=\"The node labeled 0 \"> <annotation ref=\"edge-0-1\"\/> <annotation ref=\"edge-0-2\"\/> <annotation ref=\"edge-0-3\"\/> <\/annotation> <\/annotations> <\/diagram>   "
},
{
  "id": "diagram-poset-2",
  "level": "2",
  "url": "sec-networks.html#diagram-poset-2",
  "type": "Figure",
  "number": "3.9.22",
  "title": "",
  "body": " A poset whose source is given in .     poset={ 'empty':['a', 'b', 'c'], 'a':['ab', 'ac'], 'b':['ab', 'bc'], 'c':['ac', 'bc'], 'ab':['abc'], 'ac':['abc'], 'bc':['abc'] }  labels={ 'empty':r'\\emptyset', 'a':r'\\{a\\}', 'b':r'\\{b\\}', 'c':r'\\{c\\}', 'ab':r'\\{a,b\\}', 'ac':r'\\{a,c\\}', 'bc':r'\\{b,c\\}', 'abc':r'\\{a,b,c\\}' }             "
},
{
  "id": "listing-poset-2",
  "level": "2",
  "url": "sec-networks.html#listing-poset-2",
  "type": "Listing",
  "number": "3.9.23",
  "title": "The PreFigure source for Figure 3.9.22.",
  "body": " The PreFigure source for .   <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"(25,10,25,10)\"> <definition> poset={ 'empty':['a', 'b', 'c'], 'a':['ab', 'ac'], 'b':['ab', 'bc'], 'c':['ac', 'bc'], 'ab':['abc'], 'ac':['abc'], 'bc':['abc'] } <\/definition> <definition> labels={ 'empty':r'\\emptyset', 'a':r'\\{a\\}', 'b':r'\\{b\\}', 'c':r'\\{c\\}', 'ab':r'\\{a,b\\}', 'ac':r'\\{a,c\\}', 'bc':r'\\{b,c\\}', 'abc':r'\\{a,b,c\\}' } <\/definition> <poset covers=\"poset\" labels=\"labels\" centered-labels=\"yes\"\/> <annotations text=\"A poset formed by subset inclusion\"> <annotation ref=\"empty\" text=\"The empty set is contained in all singletons\"> <annotation ref=\"edge-empty-a\"\/> <annotation ref=\"edge-empty-b\"\/> <annotation ref=\"edge-empty-c\"\/> <\/annotation> <\/annotations> <\/diagram>   "
},
{
  "id": "diagram-poset-3",
  "level": "2",
  "url": "sec-networks.html#diagram-poset-3",
  "type": "Figure",
  "number": "3.9.24",
  "title": "",
  "body": " The coordinates defined by the automatic placement of nodes.     poset={0:[1,2,3], 1:[4,5], 2:[4,6], 3:[5,6], 4:[7], 5:[7], 6:[7]}         "
},
{
  "id": "diagram-poset-4",
  "level": "2",
  "url": "sec-networks.html#diagram-poset-4",
  "type": "Figure",
  "number": "3.9.25",
  "title": "",
  "body": " A poset with some nodes and alignments defined by the author. The source is in .     poset={0:[1,2,3], 1:[4,5], 2:[4,6], 3:[5,6], 4:[7], 5:[7], 6:[7]}  locations={4:(-0.7, 2.5), 5:(0.5,2), 7:(-0.5,3)}  alignments={0:'se',1:'nw',2:'se',3:'ne',4:'nw',5:'e',6:'ne',7:'ne'}      "
},
{
  "id": "listing-poset-4",
  "level": "2",
  "url": "sec-networks.html#listing-poset-4",
  "type": "Listing",
  "number": "3.9.26",
  "title": "The PreFigure source for Figure 3.9.25.",
  "body": " The PreFigure source for .   <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"25\"> <definition> poset={0:[1,2,3], 1:[4,5], 2:[4,6], 3:[5,6], 4:[7], 5:[7], 6:[7]} <\/definition> <definition> locations={4:(-0.7, 2.5), 5:(0.5,2), 7:(-0.5,3)} <\/definition> <definition> alignments={0:'se',1:'nw',2:'se',3:'ne',4:'nw',5:'e',6:'ne',7:'ne'} <\/definition> <poset covers=\"poset\" labeled=\"yes\" node-style=\"box\" node-size=\"6\" locations=\"locations\" alignments=\"alignments\"\/> <\/diagram>   "
},
{
  "id": "diagram-poset-5",
  "level": "2",
  "url": "sec-networks.html#diagram-poset-5",
  "type": "Figure",
  "number": "3.9.27",
  "title": "",
  "body": " A poset with an author-defined <node> element. The source is in .     poset={0:[1,2], 1:[4,5], 3:[4,5], 4:[5], 5:[6], 6:[7], 8:[]}   Blue      "
},
{
  "id": "listing-poset-5",
  "level": "2",
  "url": "sec-networks.html#listing-poset-5",
  "type": "Listing",
  "number": "3.9.28",
  "title": "The PreFigure source for Figure 3.9.27.",
  "body": " The PreFigure source for .   <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"25\"> <definition> poset={0:[1,2], 1:[4,5], 3:[4,5], 4:[5], 5:[6], 6:[7], 8:[]} <\/definition> <poset covers=\"poset\" labeled=\"yes\" node-style=\"box\" node-size=\"12\" locations=\"{3:(1,0), 1:(-0.8,1), 2:(0.8,2), 8:(1,4)}\"> <node at=\"4\" p=\"(-0.15,1.8)\" alignment=\"s\" style=\"circle\" size=\"20\" fill=\"cornflowerblue\"> Blue <\/node> <\/poset> <\/diagram>   "
},
{
  "id": "sec-paths",
...
},
{
  ...
  "number": "3.10.8",
  "title": "",
  "body": "        coil     wave     capacitor     zigzag     ragged      Some path decorations.  "
},
{
  ...
  "body": "  <diagram dimensions=\"(400,250)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <coordinates bbox=\"(-3,0,10,10)\"> <path start=\"(1,9)\" closed=\"no\" arrows=\"2\" stroke=\"blue\"> <rlineto point=\"(8,0)\" decoration=\"coil; number=10; dimensions=(10,10)\"\/> <\/path> <label anchor=\"(0,9)\" alignment=\"w\">coil<\/label> <path start=\"(1,7)\" closed=\"no\" arrows=\"2\" stroke=\"blue\"> <rlineto point=\"(8,0)\" decoration=\"wave; number=10; dimensions=(10,10)\"\/> <\/path> <label anchor=\"(0,7)\" alignment=\"w\">wave<\/label> <path start=\"(1,5)\" closed=\"no\" arrows=\"2\" stroke=\"blue\"> <rlineto point=\"(8,0)\" decoration=\"capacitor; dimensions=(10,10)\"\/> <\/path> <label anchor=\"(0,5)\" alignment=\"w\">capacitor<\/label> <path start=\"(1,3)\" closed=\"no\" arrows=\"2\" stroke=\"blue\"> <rlineto point=\"(8,0)\" decoration=\"zigzag; number=10; dimensions=(10,10)\"\/> <\/path> <label anchor=\"(0,3)\" alignment=\"w\">zigzag<\/label> <path start=\"(1,1)\" closed=\"no\" arrows=\"0\" stroke=\"blue\"> <rlineto point=\"(8,0)\" decoration=\"ragged; step=7; offset=4; seed=11\"\/> <\/path> <label anchor=\"(0,1)\" alignment=\"w\">ragged<\/label> <\/coordinates> <\/diagram>   The PreFigure source for the coils in .  "
},
{
  "id": "diagram-coils",
  "level": "2",
...
},
{
  ...
  "number": "3.12.1",
  "title": "",
  "body": "     x=filter(df, 'sepal length', 'species', 'Iris-versicolor')  y=filter(df, 'petal width', 'species', 'Iris-versicolor')  points=zip_lists(x, y)    Sepal length  Petal width        A scatter plot built from the source in .  "
},
{
...
},
{
  ...
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(400,300)\" margins=\"(30,30,5,5)\"> <read name=\"df\" filename=\"iris.data\" string-columns=\"['species']\"\/> <coordinates bbox=\"(3,0,9,25)\"> <grid-axes> <ylabel alignment=\"se\">Sepal length<\/ylabel> <\/grid-axes> <histogram at=\"histogram\" data=\"df['sepal length']\" outline=\"tactile\" min=\"4\" max=\"9\" bins=\"20\" fill=\"lightskyblue\" stroke=\"black\" annotate=\"yes\" text=\"The histogram with 20 bins\" bin-text=\"A bin from ${__histogram_x[bin_num]}\"\/> <\/coordinates> <annotations text=\"A histogram of irises with 30 bins grouped by sepal length\"> <annotation ref=\"histogram\"\/> <\/annotations> <\/diagram>   The source for .  "
},
{
  "id": "diagram-gragg",
  "level": "2",
...
},
{
  ...
  "type": "Section",
  "number": "3.13",
  "title": "Loading external images",
  "body": " Loading external images  Some diagrams may need to import an external image and then add some features. For instance, one may want to load a topographical map and add a vector indicating the gradient of the elevation function. supports importing PNG, JPEG, GIF, and SVG images with the <image> element. and the accompanying source demonstrate.        A topological map with a vector   tail=(4.6,5.6)        This diagram contains a PNG image that is loaded from an external file. Image courtesy of the United States Geological Survey.     <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <coordinates bbox=\"(0,0,10,10)\"> <image lower-left=\"(0,0)\" dimensions=\"(10,10)\" source=\"images\/wasatch.png\" opacity=\"0.6\"> <label anchor=\"(0,10)\" alignment=\"se\"> A topological map with a vector <\/label> <\/image> <definition>tail=(4.6,5.6)<\/definition> <vector tail=\"tail\" v=\"(2,2.5)\" stroke=\"blue\"\/> <point p=\"tail\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .   The source attribute is the name of the file that contains the image. Finding this image file in the local file system is handled in the same way that external data files are found, as described in . That is to say, if there is a publication file, then the value of the attribute directories\/data is prepended to the value of the image\/source attribute. For instance, if source=\"images\/my_image.jpg\" and directories\/data=\"\/home\/user\/projects\/\" , then will expect the image file to be in \/home\/user\/projects\/images\/my_image.jpg\" .  If directories\/data is not given in a publication file, then the value of source is interpreted relative to the source file.  Within a PreTeXt project, the value of docinfo\/data should be a directory that contains the image file, possibly in a sub-directory as indicated by the value of image\/source . For example, if source=\"images\/my_image.jpg\" and docinfo\/data=\"\/home\/book\/source\/data\" , then the file should live at \/home\/book\/source\/data\/images\/my_image.jpg . (Of course, one would not likely give an absolute path in docinfo\/data .)  attempts to identify the image format from the file name's suffix. For instance, image.gif is assumed to be a GIF. If the file name suffix does not properly denote the image type, include the attribute filetype , whose value can be \"svg\" , \"png\" , \"gif\" , \"jpg\" , or \"jpeg\" .  The location and sizing of the image is determined by a rectangle defined through the attributes center , lower-left , and dimensions . Only one of center and lower-left needs to be given. The image will be scaled in such a way so as to preserve its aspect ratio and to fit inside the rectangle.  Additional attributes include rotate , which defines an angle, epxressed in degrees, by which the image is to be rotated about its center. The attribute scale can be either a single number or an ordered pair to scale by different amounts horizontally and vertically. Scaling is not strictly enforced, however, since the image is already scaled to fit inside the prescribed rectangle. What may be most useful is scale=\"(-1,1)\" to flip the image. Finally, opacity gives a value for the opacity to use when including the image, as demonstrated in .   Caution  Because prioritizes accessible diagrams and imported images will likely not render well in an embossed tactile format, an <image> element must include elements intended to replace the image in a tactile diagram. Notice that the <image> in contains a label with a brief description.   illustrates a version of a diagram from the  PreTeXt sample article. Notice how the image of the shark is scaled to flip it horizontally. A rectangle is also drawn around the swimmer to illustrate how the image is scaled to fit inside its rectangle (and to protect the swimmer from the shark). Finally, note that the tactile replacements for these images each consist of a labeled point showing the location of the shark and the swimmer. Thanks to Stephen Brown for permission to reproduce this image.              Shark    Swimmer      70 \\mathrm{ m}    50 \\mathrm{ m}    0 \\mathrm{ m}       This diagram loads two images, one for the shark and one for the swimmer.     <diagram dimensions=\"(540, 240)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <coordinates bbox=\"(0,0,9,4)\"> <rectangle lower-left=\"(8,0)\" dimensions=\"(1,2)\" fill=\"yellow\" stroke=\"none\" fill-opacity=\"0.3\"\/> <path start=\"(0,0)\" closed=\"yes\" fill=\"lightsteelblue\"> <lineto point=\"(0,2)\"\/> <lineto point=\"(8.1,2)\" decoration=\"ragged; step=7; offset=4; seed=1\"\/> <lineto point=\"(8.1,0)\" decoration=\"ragged; step=7; offset=4; seed=1\"\/> <\/path> <image center=\"(1.5,1)\" dimensions=\"(3,1)\" source=\"images\/shark.png\" scale=\"(-1,1)\"> <point p=\"(1.5,1)\"> Shark <\/point> <\/image> <image center=\"(5,1)\" dimensions=\"(1,2)\" source=\"images\/swimmer.png\"> <point p=\"(5,1)\"> Swimmer <\/point> <\/image> <rectangle center=\"(5,1)\" dimensions=\"(1,2)\" dash=\"9 9\" stroke=\"gray\"\/> <line endpoints=\"((1.5,3),(8,3))\" stroke=\"black\"\/> <tick-mark location=\"(1.5,3)\" size=\"(5,5)\" alignment=\"n\" offset=\"(0,4)\"> <m>70 \\mathrm{ m}<\/m> <\/tick-mark> <tick-mark location=\"(5,3)\" size=\"(5,5)\" alignment=\"n\" offset=\"(0,4)\"> <m>50 \\mathrm{ m}<\/m> <\/tick-mark> <tick-mark location=\"(8,3)\" size=\"(5,5)\" alignment=\"n\" offset=\"(0,4)\"> <m>0 \\mathrm{ m}<\/m> <\/tick-mark> <\/coordinates> <\/diagram>   The PreFigure source for .   "
},
{
  "id": "diagram-wasatch",
  "level": "2",
  "url": "sec-images.html#diagram-wasatch",
  "type": "Figure",
  "number": "3.13.1",
  "title": "",
  "body": "      A topological map with a vector   tail=(4.6,5.6)        This diagram contains a PNG image that is loaded from an external file. Image courtesy of the United States Geological Survey.  "
},
{
  "id": "listing-wasatch",
  "level": "2",
  "url": "sec-images.html#listing-wasatch",
  "type": "Listing",
  "number": "3.13.2",
  "title": "The PreFigure source for Figure 3.13.1.",
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <coordinates bbox=\"(0,0,10,10)\"> <image lower-left=\"(0,0)\" dimensions=\"(10,10)\" source=\"images\/wasatch.png\" opacity=\"0.6\"> <label anchor=\"(0,10)\" alignment=\"se\"> A topological map with a vector <\/label> <\/image> <definition>tail=(4.6,5.6)<\/definition> <vector tail=\"tail\" v=\"(2,2.5)\" stroke=\"blue\"\/> <point p=\"tail\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "diagram-attack",
  "level": "2",
  "url": "sec-images.html#diagram-attack",
  "type": "Figure",
  "number": "3.13.3",
  "title": "",
  "body": "            Shark    Swimmer      70 \\mathrm{ m}    50 \\mathrm{ m}    0 \\mathrm{ m}       This diagram loads two images, one for the shark and one for the swimmer.  "
},
{
  "id": "listing-attack",
  "level": "2",
  "url": "sec-images.html#listing-attack",
  "type": "Listing",
  "number": "3.13.4",
  "title": "The PreFigure source for Figure 3.13.3.",
  "body": "  <diagram dimensions=\"(540, 240)\" margins=\"5\" xmlns=\"https:\/\/prefigure.org\"> <coordinates bbox=\"(0,0,9,4)\"> <rectangle lower-left=\"(8,0)\" dimensions=\"(1,2)\" fill=\"yellow\" stroke=\"none\" fill-opacity=\"0.3\"\/> <path start=\"(0,0)\" closed=\"yes\" fill=\"lightsteelblue\"> <lineto point=\"(0,2)\"\/> <lineto point=\"(8.1,2)\" decoration=\"ragged; step=7; offset=4; seed=1\"\/> <lineto point=\"(8.1,0)\" decoration=\"ragged; step=7; offset=4; seed=1\"\/> <\/path> <image center=\"(1.5,1)\" dimensions=\"(3,1)\" source=\"images\/shark.png\" scale=\"(-1,1)\"> <point p=\"(1.5,1)\"> Shark <\/point> <\/image> <image center=\"(5,1)\" dimensions=\"(1,2)\" source=\"images\/swimmer.png\"> <point p=\"(5,1)\"> Swimmer <\/point> <\/image> <rectangle center=\"(5,1)\" dimensions=\"(1,2)\" dash=\"9 9\" stroke=\"gray\"\/> <line endpoints=\"((1.5,3),(8,3))\" stroke=\"black\"\/> <tick-mark location=\"(1.5,3)\" size=\"(5,5)\" alignment=\"n\" offset=\"(0,4)\"> <m>70 \\mathrm{ m}<\/m> <\/tick-mark> <tick-mark location=\"(5,3)\" size=\"(5,5)\" alignment=\"n\" offset=\"(0,4)\"> <m>50 \\mathrm{ m}<\/m> <\/tick-mark> <tick-mark location=\"(8,3)\" size=\"(5,5)\" alignment=\"n\" offset=\"(0,4)\"> <m>0 \\mathrm{ m}<\/m> <\/tick-mark> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "sec-publication",
  "level": "1",
...
},
{
  ...
  "body": " The <repeat> element  Some diagrams contain a number of components that are similar and differ only in a few attributes. For example, shows several solutions to a differential equation with different initial values.      Several solutions to a differential equation.   Of course, we could simply include a <plot-de-solution> element for each one, but this could be difficult to maintain if we decide to make some small change. Instead, PreFigure offers a <repeat> element that can streamline this process, as illustrated by the PreFigure source code in .    <diagram dimensions=\"(300,300)\" margins=\"10\"> <definition>f(t,y) = t-y<\/definition> <coordinates bbox=\"[-4,-4,4,4]\"> <grid at=\"grid\"\/> <axes at=\"axes\" xlabel=\"t\" ylabel=\"y\"\/> <slope-field at=\"slope-field\" function=\"f\"\/> <repeat parameter=\"k=-4..4\"> <plot-de-solution at=\"solution\" function=\"f\" t0=\"0\" y0=\"k\" stroke=\"orange\" \/> <point at=\"initial-value\" p=\"(0,k)\" size=\"4\" fill=\"orange\" \/> <\/repeat> <\/coordinates> <annotations text=\"Solutions to the differential equation dy dt = t - y\"> <annotation ref=\"grid\" text=\"The coordinate grid\"\/> <annotation ref=\"axes\" text=\"The coordinate axes\"\/> <annotation ref=\"slope-field\" text=\"The slope field\"\/> <annotation ref=\"solutions\" text=\"A collection of solution curves\"> <annotation ref=\"solution-k_-4\" text=\"The solution with initial value -4\"\/> <annotation ref=\"solution-k_-3\" text=\"The solution with initial value -3\"\/> <annotation ref=\"solution-k_-2\" text=\"The solution with initial value -2\"\/> <annotation ref=\"solution-k_-1\" text=\"The solution with initial value -1\"\/> <annotation ref=\"solution-k_0\" text=\"The solution with initial value 0\"\/> <annotation ref=\"solution-k_1\" text=\"The solution with initial value 1\"\/> <annotation ref=\"solution-k_2\" text=\"The solution with initial value 2\"\/> <annotation ref=\"solution-k_3\" text=\"The solution with initial value 3\"\/> <annotation ref=\"solution-k_4\" text=\"The solution with initial value 4\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for .   Line 7 contains a <repeat> element with the attribute parameter=\"k=-4..4\" . This places the parameter name k into the user namespace with the value of -4 and adds the <plot-de-solution> and <point> elements contained within the <repeat> element. This repeats with the values .  The annotations included in show how the handles within the <repeat> element are generated. If an element inside a repeat element has a handle at=\"handle\" , then the graphical component generated when the parameter is, say, param=value is given the handle at=\"handle-param_value\" . For example, when k=2 , the solution has the handle at=\"solution-k_2\" . There is not yet a repeat feature for annotations.   Update: 2025-12-20  Long-time authors may notice a change in how the handles of elements formed within in a <repeat> element are created as handles formerly had the form at=\"handle-param=value\" . However, = is not an allowed character in an id attribute in an SVG included in an EPUB document. This explains the change, which happened in version 0.4.7 of the prefig module.  The preprocessor should convert the old syntax to the new while also generating an error message. Authors are encouraged to verify the results if they see such an error message or, better, to update their source.  See for more information.   A second example, given in , shows how labels can be managed within a <repeat> element.      The roots of unity.     <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition> alignments=['ne','ne','ne','nw','nw','sw','se','se'] <\/definition> <definition substitution=\"no\"> labels=['1',r'\\omega','i',r'\\omega^3','-1',r'\\omega^5','-i',r'\\omega^7'] <\/definition> <definition>f(t)=(cos(pi*t\/4),sin(pi*t\/4))<\/definition> <coordinates bbox=\"[-1.4,-1.4,1.4,1.4]\"> <grid at=\"grid\" \/> <axes at=\"axes\" decorations=\"no\" \/> <circle at=\"unit-circle\" center=\"(0,0)\" radius=\"1\" stroke=\"blue\"\/> <repeat parameter=\"k=0..7\"> <point at=\"point\" p=\"f(k)\" alignment=\"alignments[k]\"> <m>${labels[k]}<\/m> <\/point> <\/repeat> <\/coordinates> <annotations text=\"The eighth roots of unity\"> <annotation ref=\"axes\" text=\"The coordinate axes\" \/> <annotation ref=\"grid\" text=\"The coordinate grid\" \/> <annotation ref=\"unit-circle\" text=\"The unit circle\" circular=\"yes\"> <annotation ref=\"point-k_0\" text=\"The primitive eighth root of unity to the power zero\" speech=\"one\"\/> <annotation ref=\"point-k_1\" text=\"The primitive eighth root of unity\" speech=\"omega\"\/> <annotation ref=\"point-k_2\" text=\"The primitive eighth root of unity squared\" speech=\"i\"\/> <annotation ref=\"point-k_3\" text=\"The primitive eighth root of unity cubed\" speech=\"omega cubed\"\/> <annotation ref=\"point-k_4\" text=\"The primitive eighth root of unity to the fourth\" speech=\"minus one\"\/> <annotation ref=\"point-k_5\" text=\"The primitive eighth root of unity to the fifth\" speech=\"omega to the fifth\"\/> <annotation ref=\"point-k_6\" text=\"The primitive eighth root of unity to the sixth\" speech=\"minus i\"\/> <annotation ref=\"point-k_7\" text=\"The primitive eighth root of unity to the seventh\" speech=\"omega to the seventh\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for .   Lines 5 through 7 define a set of labels, one for each of the eight points. Remember that ^ is usually interpreted as the numerical exponentiation operator. Since we wish to preserve this character for the label, we include the attribute substitution=\"no\" to prevent ^ being reinterpreted. Notice that the label is given as ${labels[k]} since anything inside ${...} is evaluated in the user namespace.  It is also possible to define the parameter attribute so that we iterate over a list. For instance parameter=\"point in [[0,0],[3,0],[0,4]]\" the elements inside the <repeat> will be visited three times with the value of point being set to each of the points in the list. This is demonstrated in .   Using a <repeat> to iterate over the elements in a list.      <diagram dimensions=\"(300,300)\" margins=\"5\"> <coordinates bbox=\"(0,0,10,10)\"> <definition>centers=((2,2),(3,7),(6,4),(8,7))<\/definition> <grid-axes decorations=\"no\"\/> <repeat parameter=\"center in centers\"> <circle center=\"center\" radius=\"1\" fill=\"springgreen\" stroke=\"black\"\/> <\/repeat> <\/coordinates> <\/diagram>   The PreFigure source for .   We can also nest <repeat> elements as illustrated in and source .      A <repeat> nested inside another.     <diagram dimensions=\"(300,300)\" margins=\"5\"> <coordinates bbox=\"[-1,-1,5,5]\"> <grid\/> <repeat parameter=\"row=0..4\"> <repeat parameter=\"col=0..4\"> <rectangle at=\"rectangle\" center=\"(col, row)\" dimensions=\"(3\/4,3\/4)\" fill=\"blue\"\/> <\/repeat> <\/repeat> <\/coordinates> <\/diagram>   The PreFigure source for .   A typical handle for one of these rectangles is at=\"rectangle-row_2-col_1\" .  "
},
{
...
},
{
  ...
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"10\"> <definition>f(t,y) = t-y<\/definition> <coordinates bbox=\"[-4,-4,4,4]\"> <grid at=\"grid\"\/> <axes at=\"axes\" xlabel=\"t\" ylabel=\"y\"\/> <slope-field at=\"slope-field\" function=\"f\"\/> <repeat parameter=\"k=-4..4\"> <plot-de-solution at=\"solution\" function=\"f\" t0=\"0\" y0=\"k\" stroke=\"orange\" \/> <point at=\"initial-value\" p=\"(0,k)\" size=\"4\" fill=\"orange\" \/> <\/repeat> <\/coordinates> <annotations text=\"Solutions to the differential equation dy dt = t - y\"> <annotation ref=\"grid\" text=\"The coordinate grid\"\/> <annotation ref=\"axes\" text=\"The coordinate axes\"\/> <annotation ref=\"slope-field\" text=\"The slope field\"\/> <annotation ref=\"solutions\" text=\"A collection of solution curves\"> <annotation ref=\"solution-k_-4\" text=\"The solution with initial value -4\"\/> <annotation ref=\"solution-k_-3\" text=\"The solution with initial value -3\"\/> <annotation ref=\"solution-k_-2\" text=\"The solution with initial value -2\"\/> <annotation ref=\"solution-k_-1\" text=\"The solution with initial value -1\"\/> <annotation ref=\"solution-k_0\" text=\"The solution with initial value 0\"\/> <annotation ref=\"solution-k_1\" text=\"The solution with initial value 1\"\/> <annotation ref=\"solution-k_2\" text=\"The solution with initial value 2\"\/> <annotation ref=\"solution-k_3\" text=\"The solution with initial value 3\"\/> <annotation ref=\"solution-k_4\" text=\"The solution with initial value 4\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for .  "
},
{
  "id": "diagram-unity",
  "level": "2",
...
},
{
  ...
  "body": "  <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition> alignments=['ne','ne','ne','nw','nw','sw','se','se'] <\/definition> <definition substitution=\"no\"> labels=['1',r'\\omega','i',r'\\omega^3','-1',r'\\omega^5','-i',r'\\omega^7'] <\/definition> <definition>f(t)=(cos(pi*t\/4),sin(pi*t\/4))<\/definition> <coordinates bbox=\"[-1.4,-1.4,1.4,1.4]\"> <grid at=\"grid\" \/> <axes at=\"axes\" decorations=\"no\" \/> <circle at=\"unit-circle\" center=\"(0,0)\" radius=\"1\" stroke=\"blue\"\/> <repeat parameter=\"k=0..7\"> <point at=\"point\" p=\"f(k)\" alignment=\"alignments[k]\"> <m>${labels[k]}<\/m> <\/point> <\/repeat> <\/coordinates> <annotations text=\"The eighth roots of unity\"> <annotation ref=\"axes\" text=\"The coordinate axes\" \/> <annotation ref=\"grid\" text=\"The coordinate grid\" \/> <annotation ref=\"unit-circle\" text=\"The unit circle\" circular=\"yes\"> <annotation ref=\"point-k_0\" text=\"The primitive eighth root of unity to the power zero\" speech=\"one\"\/> <annotation ref=\"point-k_1\" text=\"The primitive eighth root of unity\" speech=\"omega\"\/> <annotation ref=\"point-k_2\" text=\"The primitive eighth root of unity squared\" speech=\"i\"\/> <annotation ref=\"point-k_3\" text=\"The primitive eighth root of unity cubed\" speech=\"omega cubed\"\/> <annotation ref=\"point-k_4\" text=\"The primitive eighth root of unity to the fourth\" speech=\"minus one\"\/> <annotation ref=\"point-k_5\" text=\"The primitive eighth root of unity to the fifth\" speech=\"omega to the fifth\"\/> <annotation ref=\"point-k_6\" text=\"The primitive eighth root of unity to the sixth\" speech=\"minus i\"\/> <annotation ref=\"point-k_7\" text=\"The primitive eighth root of unity to the seventh\" speech=\"omega to the seventh\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for .  "
},
{
...
},
{
  ...
  "body": "  <diagram dimensions=\"(400,400)\" margins=\"5\"> <coordinates bbox=\"(0,0,10,10)\"> <grid-axes decorations=\"no\"\/> <!-- left side arrows --> <line endpoints=\"((1,9),(4,9))\" arrows=\"2\"\/> <line endpoints=\"((1,8),(4,8))\" arrows=\"2\" arrow-width=\"5\"\/> <line endpoints=\"((1,7),(4,7))\" arrows=\"2\" arrow-width=\"6\"\/> <line endpoints=\"((1,6),(4,6))\" arrows=\"2\" arrow-width=\"7\"\/> <line endpoints=\"((1,5),(4,5))\" arrows=\"2\" arrow-width=\"8\"\/> <line endpoints=\"((1,4),(4,4))\" arrows=\"2\" arrow-width=\"9\"\/> <!-- right side arrows --> <line endpoints=\"((6,9),(9,9))\" arrows=\"2\" arrow-width=\"5\" arrow-angles=\"(35,60)\"\/> <line endpoints=\"((6,8),(9,8))\" arrows=\"2\" arrow-width=\"5\" arrow-angles=\"(40,60)\"\/> <line endpoints=\"((6,7),(9,7))\" arrows=\"2\" arrow-width=\"6\" arrow-angles=\"(45,60)\"\/> <line endpoints=\"((6,6),(9,6))\" arrows=\"2\" arrow-width=\"7\" arrow-angles=\"(35,80)\"\/> <line endpoints=\"((6,5),(9,5))\" arrows=\"2\" arrow-width=\"8\" arrow-angles=\"(40,80)\"\/> <line endpoints=\"((6,4),(9,4))\" stroke=\"red\" arrows=\"2\" arrow-width=\"9\" arrow-angles=\"(40,80)\"\/> <!-- longer line at the bottom --> <line endpoints=\"((1,3),(9,3))\" arrows=\"2\" additional-arrows=\"(0.7,0.5)\" arrow-width=\"9\" arrow-angles=\"(60,90)\"\/> <line endpoints=\"((1,2),(9,2))\" arrows=\"2\" arrow-width=\"9\" arrow-angles=\"(30,80)\"\/> <line endpoints=\"((1,1),(9,1))\" arrows=\"2\" arrow-width=\"9\" arrow-angles=\"(10,90)\" additional-arrows=\"0.5\"\/> <\/coordinates> <\/diagram>   The PreFigure source for .  "
},
{
...
{
  "id": "diagram-transform-3",
  "level": "2",
  "url": "sec-transforms.html#diagram-transform-3",
  "type": "Figure",
  "number": "5.3.5",
  "title": "",
  "body": " An example of the <change-basis> element     v1=(2,1)  v2=(1,2)         {\\mathbf v}_1    {\\mathbf v}_2         "
},
{
  "id": "listing-transform-3",
  "level": "2",
  "url": "sec-transforms.html#listing-transform-3",
  "type": "Listing",
  "number": "5.3.6",
  "title": "The PreFigure source for Figure 5.3.5.",
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <definition>v1=(2,1)<\/definition> <definition>v2=(1,2)<\/definition> <coordinates bbox=\"(-4,-4,4,4)\"> <grid\/> <transform> <change-basis basis=\"(v1,v2)\"\/> <rectangle lower-left=\"(0,0)\" dimensions=\"(1,1)\" fill=\"lightgray\"\/> <grid stroke=\"gray\" cliptobbox=\"yes\"\/> <vector v=\"(1,0)\" stroke=\"blue\"> <m>{\\mathbf v}_1<\/m> <\/vector> <vector v=\"(0,1)\" stroke=\"blue\"> <m>{\\mathbf v}_2<\/m> <\/vector> <\/transform> <axes decorations=\"no\"\/> <\/coordinates> <\/diagram>   The source for .  "
},
{
...
},
{
  ...
  "type": "Listing",
  "number": "5.3.18",
  "title": "The PreFigure source for Figure 5.3.17.",
...
},
{
  ...
  "number": "6.1.1",
  "title": "",
  "body": "    a=1  f(x)=exp(x\/3)*cos(x)         (a,f(a))               A calculus diagram  "
},
{
  ...
  "body": "  <diagram xmlns=\"https:\/\/prefigure.org\" dimensions=\"(300, 300)\" margins=\"5\"> <definition> a=1 <\/definition> <definition> f(x)=exp(x\/3)*cos(x) <\/definition> <coordinates bbox=\"[-4,-4,4,4]\"> <grid-axes xlabel=\"x\" ylabel=\"y\"\/> <graph at=\"function\" function=\"f\"\/> <tangent-line at=\"tangent\" function=\"f\" point=\"a\"\/> <group at=\"point\"> <point p=\"(a, f(a))\"\/> <label anchor=\"(a, f(a))\" alignment=\"ne\"> <m>(a,f(a))<\/m> <\/label> <\/group> <\/coordinates> <annotations text=\"The graph of a function and its tangent line at the point a equals 1\"> <annotation ref=\"graph-tangent\" text=\"The graph and its tangent line\"> <annotation ref=\"function\" text=\"The graph of the function f\" sonify=\"yes\"\/> <annotation ref=\"point\" text=\"The point a comma f of a\"\/> <annotation ref=\"tangent\" text=\"The tangent line to the graph of f at the point\" sonify=\"yes\" speech=\"This line is y equals f of a plus the derivative at a times the quantity x minus a\"\/> <\/annotation> <\/annotations> <\/diagram>   The PreFigure source for .  "
},
{
...
{
  "id": "listing-annotation-web-page",
  "level": "2",
  "url": "sec-annotations.html#listing-annotation-web-page",
  "type": "Listing",
  "number": "6.1.5",
  "title": "An HTML framework for including an annotated diagram on a web page.",
  "body": "  <html> <head> <script type=\"text\/javascript\" src=\"https:\/\/cdn.jsdelivr.net\/npm\/diagcess@1.3.3\/dist\/diagcess.js\" defer> <\/script> <script type=\"text\/javascript\" defer> document.addEventListener(\"DOMContentLoaded\", function() { diagcess.Base.init(); }); <\/script> <\/head> <body> <div class=\"ChemAccess-element\" data-src=\"tangent.svg\" data-cml=\"tangent-annotations.xml\"> <\/div> <\/body> <\/html>   An HTML framework for including an annotated diagram on a web page.  "
},
{
  "id": "sec-tactile",
  "level": "1",
...
},
{
  ...
  "number": "7.0.13",
  "title": "",
  "body": " Eighth roots of unity   The eight roots of unity plotted on the unit circle.    alignments=['ne','ne','ne','nw','nw','sw','se','se']  labels=['1',r'\\omega','i',r'\\omega^3','-1',r'\\omega^5','-i',r'\\omega^7']  f(t)=(cos(pi*t\/4),sin(pi*t\/4))       ${labels[k]}        "
},
{
  "id": "chap-examples-16",
  "level": "2",
  ...
  "number": "7.7",
  "title": "",
  "body": "   <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition> alignments=['ne','ne','ne','nw','nw','sw','se','se'] <\/definition> <definition substitution=\"no\"> labels=['1',r'\\omega','i',r'\\omega^3','-1',r'\\omega^5','-i',r'\\omega^7'] <\/definition> <definition>f(t)=(cos(pi*t\/4),sin(pi*t\/4))<\/definition> <coordinates bbox=\"[-1.4,-1.4,1.4,1.4]\"> <grid-axes decorations=\"no\"\/> <circle at=\"unit-circle\" center=\"(0,0)\" radius=\"1\" stroke=\"blue\"\/> <repeat parameter=\"k=0..7\"> <point at=\"point\" p=\"f(k)\" alignment=\"alignments[k]\"> <m>${labels[k]}<\/m> <\/point> <\/repeat> <\/coordinates> <\/diagram>   The source for   "
},
{
...
},
{
  ...
  "number": "7.8",
  "title": "",
  "body": "   <diagram dimensions=\"(300,300)\" margins=\"5\"> <definition> f(x)=0.1*(x^4-10*x^2)<\/definition> <definition> fp(x)=deriv(f, x)<\/definition> <definition> fpp(x)=deriv(fp,x)<\/definition> <coordinates bbox=\"[-4,-4,4,4]\"> <grid-axes xlabel=\"x\" ylabel=\"y\"\/> <graph function=\"f\"\/> <label anchor=\"(3.3,1)\" alignment=\"center\" clear-background=\"yes\"> <m>f<\/m> <\/label> <graph function=\"fp\" stroke=\"red\"\/> <label anchor=\"(2.5,1)\" alignment=\"center\" clear-background=\"yes\"> <m>f'<\/m> <\/label> <graph function=\"fpp\" stroke=\"green\"\/> <label anchor=\"(1.6,1)\" alignment=\"center\" clear-background=\"yes\"> <m>f''<\/m> <\/label> <\/coordinates> <\/diagram>   The source for   "
},
{
